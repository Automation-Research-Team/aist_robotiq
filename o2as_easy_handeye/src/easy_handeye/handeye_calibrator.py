...
from o2as_easy_handeye.handeye_calibration import HandeyeCalibration
...
class HandeyeCalibrator(object):
    ...
    def _wait_for_transforms(self):
        ...
        self.listener.waitForTransform(self.tracking_base_frame, self.tracking_marker_frame, now, rospy.Duration(3))
        return now
