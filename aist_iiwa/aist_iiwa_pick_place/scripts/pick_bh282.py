...
def pick_from_table(robot, robot_name, target):
  ...
  grasp.pre_grasp_posture.joint_names = [
                robot_name + '_bh_j11_joint',
                robot_name + '_bh_j12_joint',
                robot_name + '_bh_j22_joint',
                robot_name + '_bh_j32_joint'
                ]
  ...
  jtp = JointTrajectoryPoint()
  jtp.positions = [ 0.5, 1.5, 1.5, 1.25 ]
  jtp.time_from_start.secs = 1
...
if __name__ == '__main__':
  ...
  rospy.init_node('moveit_bh282', anonymous=True)
