...
class ModelSpawnerClient(object):
    def __init__(self):
        ...
        self._add        = rospy.ServiceProxy("model_spawner/add", msrv.Add)
        self._delete     = rospy.ServiceProxy("model_spawner/add", msrv.Delete)
        self._delete_all = rospy.ServiceProxy("model_spawner/add",
                                              msrv.DeleteAll)
        self._get_list   = rospy.ServiceProxy("model_spawner/get_list",
                                              msrv.GetList)
