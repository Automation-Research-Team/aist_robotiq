...
int main (int argc, char **argv) {
  ...
  std::string movegroup_name, ee_link1, ee_link2;
  ...
  while (ros::ok()) {
    ...
    if (true) {
      ...
      if (bin == 1) {bin_header1 = "/set2_bin1"; bin_header2 = "/set2_bin2"; }
      if (bin == 2) {bin_header1 = "/set2_bin2"; bin_header2 = "/set2_bin3"; }
      if (bin == 3) {bin_header1 = "/set2_bin3"; bin_header2 = "/set2_bin4"; }

      geometry_msgs::PoseStamped ps1, ps2;
      ps1.pose = makePose(0, 0, .02);
